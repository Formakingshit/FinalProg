...
public final class UrlsConst {
    ...
    public static final String ADMIN_BOOK_ADD = ADMIN+REPORT+ADD;
    public static final String ADMIN_REPORT= ADMIN+REPORT+MAPPED_ID;
    public static final String ADMIN_BOOK_UPDATE = ADMIN+REPORT+UPDATE;
